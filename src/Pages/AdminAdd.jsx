...
const Add = ({token}) => {
  ...
  return (
    <form  onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3 text-gray-500 p-5' >
      <div >
      ...
      <div className='w-full'>
        ...
        <input onChange={(e) => setDescription(e.target.value)} value={description} className='w-full max-w-[500px] px-2 py-2' type='text' placeholder='Write content here ' required />
      </div>
